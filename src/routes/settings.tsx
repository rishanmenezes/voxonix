...
export const Route = createFileRoute("/settings")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage your Voxonix multimodal preferences, speech voices, and controls." },
    ],
  }),
    ...
    <div className="relative min-h-screen text-noir">
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-10">
        ...
        <p className="mt-1 text-sm text-noir/65">
          Configure speech output voices, gesture recognition sensitivity, and accessibility controls.
        </p>
        ...
        <div className="mt-8 space-y-6">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-noir/10 pb-3">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Select preferred voice for reading captions aloud</p>
                </div>
                <select
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-noir/10 pb-3">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Adjust playback speed for synthesized speech</p>
                </div>
                  ...
                  {[0.75, 1.0, 1.25, 1.5, 1.75].map((r) => (
                    <button
                      ...
                      className={`rounded-lg px-2.5 py-1 text-xs font-bold transition ${
                        ttsConfig.rate === r ? "bg-wine text-cream" : "bg-noir/5 text-noir/70 hover:bg-noir/10"
                      }`}
                    >
                      {r}×
                    </button>
              ...
              <div className="flex items-center justify-between pt-1">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Prevents acoustic echo loops by temporarily attenuating mic while TTS speaks</p>
                </div>
                <button
                  onClick={() => updateTTSConfig({ duckMicDuringSpeech: !ttsConfig.duckMicDuringSpeech })}
                  className={`rounded-full px-3 py-1 font-bold transition ${
                    ttsConfig.duckMicDuringSpeech ? "bg-emerald-700 text-cream" : "bg-noir/10 text-noir/60"
                  }`}
                >
          ...
          <div className="rounded-3xl border border-noir/15 bg-card p-6 shadow-sm">
            ...
            <div className="space-y-4 text-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-noir/10 pb-3">
                <div>
                  <p className="font-bold text-noir">Stability Hold Threshold ({signConfig.stabilityThresholdMs} ms)</p>
                  <p className="text-[10px] text-noir/50">Duration required to hold a sign before finalizing</p>
                </div>
                <div className="flex items-center gap-1.5">
                  {[250, 350, 500].map((t) => (
                    <button
              ...
              <div className="flex items-center justify-between pt-1">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Display landmark observation HUD and recognized letter buffer</p>
                </div>
                <button
          ...
          <div className="rounded-3xl border border-noir/15 bg-card p-6 shadow-sm">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="font-display text-xl font-bold text-noir">Captions & Visual Accessibility</h2>
            </div>
            ...
            <div className="space-y-4 text-xs">
              <div className="flex items-center justify-between border-b border-noir/10 pb-3">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Boost contrast across UI controls and subtitle bubbles</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between border-b border-noir/10 pb-3">
                <div>
                  ...
                  <p className="text-[10px] text-noir/50">Enlarge touch targets and text sizes for easier interaction</p>
                </div>
                <button
          ...
          <div className="rounded-3xl border border-noir/10 bg-background/40 p-6 flex items-center gap-3">
            ...
            <div className="text-xs">
              ...
              <p className="text-noir/60 mt-0.5">
                All WebRTC video, audio, sign landmarks, and caption streams are peer-to-peer and encrypted. No raw media is stored on external servers.
              </p>
            </div>
          </div>
        </div>
