...
export const Route = createFileRoute("/microphone-test")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Isolated microphone subsystem verification page." },
    ],
  }),
  component: MicrophoneTestPage,
});
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 py-12">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 font-display text-4xl text-noir sm:text-5xl">
            Local Microphone Subsystem
          </h1>
          <p className="mx-auto mt-3 max-w-lg text-sm text-noir/70">
            Verify permission request, MediaStream acquisition, Web Audio API signal detection,
            track muting, and teardown.
          </p>
        </div>
